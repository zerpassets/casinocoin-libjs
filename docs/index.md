...
Name | Type | Description
---- | ---- | -----------
defaultCasinocoin | boolean | *Optional* Enable [rippling](https://casinocoin.org/knowledge_center/understanding-the-nocasinocoin-flag/) on this account’s trust lines by default. (New in [casinocoind 0.27.3](https://github.com/casinocoin/casinocoind/releases/tag/0.27.3))
