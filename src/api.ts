...
export class CasinocoinAPI extends EventEmitter {
  _feeCushion: number
  _maxFeeCSC: string

  // New in > 0.21.0
  // non-validated ledger versions are allowed, and passed to casinocoind as-is.
  ...
  constructor(options: APIOptions = {}) {
    ...
    this._maxFeeCSC = options.maxFeeCSC || '2'
   ...
   *
   * See https://casinocoin.org/build/casinocoind-apis/#markers-and-pagination
   */
   ...
   * general use. Instead, use casinocoind's built-in pagination and make multiple
   * requests as needed.
   */
