...
const { computeBinaryTransactionHash } = require('casinocoin-libjs-hashes')
...
function sign(txJSON: string, secret: string, options: Object = {}): { signedTransaction: string;id: string } {
