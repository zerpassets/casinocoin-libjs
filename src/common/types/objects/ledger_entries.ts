...
import {Amount, CasinocoindAmount} from './amounts'
...
export interface CasinocoinStateLedgerEntry {
...
// see https://casinocoin.org/build/ledger-format/#ledger-object-types
