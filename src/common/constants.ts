...
// Ordering from https://casinocoin.org/build/reference-ledger-format.html#accountroot
const accountRootFlags = {

  // lsfDefaultCasinocoin:
  ...
  // lsfDisallowCSC:
  // Disallow sending CSC.
  // Not enforced by casinocoind; client applications should check.
  DisallowCSC: 0x00080000,
