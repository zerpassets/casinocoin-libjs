...
function getCSCBalance(connection: Connection, address: string,
...
function getRecursiveRecur(getter: Getter, marker ? : string, limit: number): Promise {
...
function ensureLedgerVersion(options: Object): Promise < number > {
