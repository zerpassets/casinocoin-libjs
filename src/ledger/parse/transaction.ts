...
function parseTransactionType(type) {
  // Ordering matches casinocoin.org/build/reference-transaction-format.html#transaction-types
  const mapping = {
    AccountSet: 'settings',
...
function parseTransaction(tx: any, includeRawTransaction: boolean): any {
  ...
  // if (outcome) {
  //   const channelChanges = outcome.channelChanges
  //   outcome.channelChanges = channelChanges ? removeUndefined(channelChanges) : undefined
  // }
