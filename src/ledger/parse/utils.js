...
const transactionParser = require('casinocoin-libjs-transactionparser')
...
function parseTimestamp(casinocoinTime: number): string | void {
    return casinocoinTime ? utils.common.casinocoinTimeToISO8601(casinocoinTime) : undefined
}
...
module.exports = {
    ...
    casinocoinTimeToISO8601: utils.common.casinocoinTimeToISO8601
}