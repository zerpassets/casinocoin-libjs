...
module.exports.requestBookOffersBidsPartialFundedResponse = function(
  ...
  return JSON.stringify({
    ...
    result: {
      ...
      offers: [
        {
          Account: 'cGo2RuZHiaLo9rAv4vnFbmJf1KKJV544gT',
          BookDirectory:
...
module.exports.requestBookOffersCSCBaseResponse = function(request) {
  return JSON.stringify({
    id: request.id,
    status: 'success',
    type: 'response',
    result: {
      ...
      offers: [
        {
          Account: 'cHbGn6X2MdTwD7djZE4MHG4srdFTcxdqGu',
          BookDirectory:
        ...
        {
          Account: 'cFNNwePjJmsUe5BHPwMssd6VabVyhi5yX',
          BookDirectory:
        ...
        {
          Account: 'cE53rv3q2apizKwXBiyRGCDb2VpXVXxwJz',
          BookDirectory:
        ...
        {
          Account: 'cN8hCA2TP6sjQVLXv2EiGhrjFw9YEXbsBM',
          BookDirectory:
        ...
        {
          Account: 'c9vXgWhj8uWqnmTfEjab1GK4mqSyZfEWmk',
          BookDirectory:
        ...
        {
          Account: 'cKnNiKcKu7RZ1qvXjziwn2pXu42NZhaL6F',
          BookDirectory:
        ...
        {
          Account: 'cwjtovHY2o8Wt4E8DGgtxDUVufpuBJdocv',
          BookDirectory:
...
module.exports.requestBookOffersCSCCounterResponse = function(request) {
  return JSON.stringify({
    id: request.id,
    status: 'success',
    type: 'response',
    result: {
      ...
      offers: [
        {
          Account: 'cGpbmszjw3WN6RRCgUnvjE5XDCwqT9bf3r',
          BookDirectory:
        ...
        {
          Account: 'cMwA5b4FGuv8NpWRDfSBeBUziBxZDXv4b9',
          BookDirectory:
        ...
        {
          Account: 'c3kQ4ugqYHkoKZ6QWh5d4cUEdw4RHik4SF',
          BookDirectory:
        ...
        {
          Account: 'cJf8rEtoZni1Wa9MPpnfukmFeSb6ReDXSe',
          BookDirectory:
        ...
        {
          Account: 'cGDqHSKUxi1PsvH3W4gRwGRa1W778VnngB',
          BookDirectory:
        ...
        {
          Account: 'cw5woh7HqFA2e4cA4AKLDLA7uvwiNMdnLm',
          BookDirectory:
            'DFA3B6DDAB58C7E8E5D944E736DA4B7046C30E4F460FD9DE4D077F08A879E000',
          BookNode: '0000000000000000',
          Flags: 131072,
        ...
        {
          Account: 'c9vFXWnDmVxwcmAv8dPAbLj2Z6HFAZTPdv',
          BookDirectory:
